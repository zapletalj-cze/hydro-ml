...
files = ["asc_VH_tile_index.gpkg", "asc_VV_tile_index.gpkg", "desc_VH_tile_index.gpkg", "desc_VV_tile_index.gpkg"]
CELL_SIZE = 10
EPSG = 2180
...
for file in files:
    ...
    for group in groups:
        ...
        outpath = f"{TILEINDEX_ROOT}/{outfilename}"
        mosaic_rasters = MosaicRasters(warped_rasters, output=outpath, cell_size=CELL_SIZE, epsg=EPSG, data_type=gdal.GDT_Float32, no_data=nodata, extent=extent_aoi_snapped).mosaic_in_order()
